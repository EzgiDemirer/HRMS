         ...
         <form action="{{ route('ShiftsTypes.store') }}" method="post">
            ...
            <div class="col-md-12">
               <div class="form-group">
                  ...
                  <select name="type" id="type" class="form-control">
                     ...
                     <option @if(old('type')==1) selected @endif value="1">Morning</option>
                     <option @if(old('type')==2) selected @endif value="2">Evening</option>
                     <option @if(old('type')==3) selected @endif value="3">Full Day</option>
                  </select>
                  @error('type')
            ...
            <div class="col-md-12">
               <div class="form-group text-center">
                  <button class="btn btn-sm btn-success" type="submit" name="submit">Add Shift</button>
