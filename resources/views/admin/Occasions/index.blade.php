   ...
   <div class="card">
      ...
      <div class="card-header">
         <h3 class="card-title card_title_center">
            Official Occasions Data
            <a href="{{ route('occasions.create') }}" class="btn btn-sm btn-warning">Add New</a>
         </h3>
      </div>
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td>
                     ...
                     <a href="{{ route('occasions.edit',$info->id) }}" class="btn btn-success btn-sm">
                     Edit
                     </a>

                     <a href="{{ route('occasions.destroy',$info->id) }}" class="btn are_you_shur btn-danger btn-sm">
                     Delete
                     </a>
