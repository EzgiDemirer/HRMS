...
return redirect()->route('Qualifications.index')->with(['success' => 'Data inserted successfully']);
...
if (empty($data)) {
return redirect()->route('Qualifications.index')->with(['error' => 'Unable to access the requested data']);
}
...
$checkExsists = Qualification::select("id")
