...
return redirect()->route('occasions.index')->with(['success' => 'Data inserted successfully']);
...
if (empty($data)) {
return redirect()->route('occasions.index')->with(['error' => 'This data does not exist']);
}
...
$checkExsists = Occasion::select('id')
...
return redirect()->route('occasions.index')->with(['success' => 'Data updated successfully']);
...
return redirect()->route('occasions.index')->with(['success' => 'Data deleted successfully']);

} catch (\Exception $ex) {

DB::rollBack();
return redirect()->route('occasions.index')->with(['error' => 'Sorry, something went wrong ' . $ex->getMessage()]);
