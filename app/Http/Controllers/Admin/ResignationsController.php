...
return redirect()->back()->with(['error' => 'This name already exists'])->withInput();
}
...
return redirect()->route('Resignations.index')->with(['success' => 'Data inserted successfully']);
...
if (empty($data)) {
return redirect()->route('Resignations.index')->with(['error' => 'Unable to access the requested data']);
}
...
return redirect()->route('Resignations.index')->with(['error' => 'Sorry, something went wrong ' . $ex->getMessage()]);
...
$CheckExsists = Resignation::select("id")
...
return redirect()->route('Resignations.index')->with(['success' => 'Data updated successfully']);
...
return redirect()->route('Resignations.index')->with(['success' => 'Data deleted successfully']);
